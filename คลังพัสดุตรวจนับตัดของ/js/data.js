...
const DEMO_IMAGES = {
    ...
    "1000110006": "ภาพอุปกรณ์/คอน คอร. ชนิดกลวง ที่ใช้คอนกรีตกำลังอัดสูง ขนาด 100X100X2,500 มม..png",
    "1000110009": "ภาพอุปกรณ์/คอน คอร. ชนิดกลวง ที่ใช้คอนกรีตกำลังอัดสูง ขนาด 120X120X2,500 มม..png",
...
const MASTER_ITEMS = [
    ...
    { code: "1000110009", name: "คอน คอร. ชนิดกลวง ที่ใช้คอนกรีตกำลังอัดสูง ขนาด 120X120X2,500 มม.", standard: 8, unit: "ท่อน", category: "เสาและคอน" },
    ...
    { code: "1020010007", name: "สายอลูมิเนียมเปลือย 185 ต.มม. มอก.85", standard: 200, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020020002", name: "สายอลูมิเนียมแกนเหล็ก 50/8 ต.มม. มอก.86", standard: 200, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020050000", name: "เคเบิลอากาศ อลูมิเนียม 22 เควี 1x50 ต.มม.", standard: 200, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020050004", name: "เคเบิลอากาศ อลูมิเนียม 22 เควี 1x185 ต.มม.", standard: 200, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020060004", name: "สายอลูมิเนียมหุ้มฉนวนแบบไม่เต็มพิกัด แกนเดี่ยว 22 เควี 185 ต.มม.", standard: 50, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020070002", name: "สายอลูมิเนียมตีเกลียวชนิดอัดแน่นหุ้มฉนวน พีวีซี.750 โวลท์ 75 องศาเชลเซียส 50 ต.มม.มอก.293", standard: 200, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020070004", name: "สายอลูมิเนียมตีเกลียวชนิดอัดแน่นหุ้มฉนวน พีวีซี.750 โวลท์ 75 องศาเชลเซียส 95 ต.มม.มอก.293", standard: 200, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    { code: "1020080501", name: "สายทองแดงตีเกลียวหุ้มฉนวนครอสลิงค์โพลิเอททีลินและเปลือกนอกพีวีซี 2x10 ต.มม 600 โวลท์", standard: 56, unit: "เมตร", category: "สายไฟฟ้าและเคเบิล" },
    ...
    { code: "1020200000", name: "ลวดอลูมิเนียมแบน 1x10 มม.", standard: 5, unit: "เธเธ.", category: "อุปกรณ์ต่อสาย" },
    { code: "1020200002", name: "ลวดอลูมิเนียมกลม 4.0 มม.", standard: 25, unit: "เธเธ.", category: "อุปกรณ์ต่อสาย" },
    { code: "1020200003", name: "COVERED TIE WIRE.AL.4.0 MM.", standard: 100, unit: "เน€เธกเธ•เธฃ", category: "อุปกรณ์ต่อสาย" },
    ...
    { code: "1020330005", name: "HOTLINE BAIL-CLAMP,MAIN 35-70 SQ.MM.", standard: 20, unit: "เธเธธเธ”", category: "เนเธเธฅเนเธกเธเนเนเธฅเธฐเธเธญเธเน€เธเธเน€เธ•เธญเธฃเน" },
    { code: "1020330006", name: "HOTLINE BAIL-CLAMP,MAIN 70-185 SQ.MM.", standard: 20, unit: "เธเธธเธ”", category: "เนเธเธฅเนเธกเธเนเนเธฅเธฐเธเธญเธเน€เธเธเน€เธ•เธญเธฃเน" },
    ...
    { code: "1020420102", name: "เธซเธฒเธเธเธฅเธฒ เน€เธเธฒเธฐเธฃเธนเธ•เธฒเธกเธกเธฒเธ•เธฃเธเธฒเธเน€เธเธกเนเธฒ เธชเธณเธซเธฃเธฑเธเธชเธฒเธขเธญเธฅเธนเธกเธดเน€เธเธตเธขเธก 50 เธ•.เธกเธก.", standard: 45, unit: "เธญเธฑเธ", category: "อุปกรณ์ต่อสาย" },
    { code: "1020420104", name: "เธซเธฒเธเธเธฅเธฒ เน€เธเธฒเธฐเธฃเธนเธ•เธฒเธกเธกเธฒเธ•เธฃเธเธฒเธเน€เธเธกเนเธฒ เธชเธณเธซเธฃเธฑเธเธชเธฒเธขเธญเธฅเธนเธกเธดเน€เธเธตเธขเธก 95 เธ•.เธกเธก.", standard: 45, unit: "เธญเธฑเธ", category: "อุปกรณ์ต่อสาย" },
    ...
    { code: "1040000000", name: "ล่อฟ้า 21 เควี 5 กิโลแอมป์", standard: 20, unit: "เธเธธเธ”", category: "ล่อฟ้าและฟิวส์" },
    ...
    { code: "1040010002", name: "เธ”เธฃเธญเธเน€เธญเธฒเธ—เนเธเธดเธงเธชเนเธเธฑเธ—เน€เธญเธฒเธ—เน เธซเธเธถเนเธเธญเธดเธเธเธนเน€เธฅเน€เธ•เธญเธฃเน 22 เน€เธเธงเธต 100 เนเธญเธกเธเน 12 เน€เธเน€เธญ เธญเธชเธกเธกเธฒเธ•เธฃ", standard: 15, unit: "เธเธธเธ”", category: "ล่อฟ้าและฟิวส์" },
    { code: "1040010006", name: "เธเธฃเธฐเธเธญเธเธเธดเธงเธชเน 22 เน€เธเธงเธต 100 เนเธญเธกเธเน 12 เน€เธเน€เธญ เธญเธชเธกเธกเธฒเธ•เธฃ", standard: 30, unit: "เธเธธเธ”", category: "ล่อฟ้าและฟิวส์" },
    ...
    { code: "1040020016", name: "H.R.C. FUSE, BLADE CONTACT, 250 A", standard: 70, unit: "เธญเธฑเธ", category: "ล่อฟ้าและฟิวส์" },
    { code: "1040020017", name: "H.R.C. FUSE, BLADE CONTACT, 315 A", standard: 20, unit: "อัน", category: "ล่อฟ้าและฟิวส์" },
    { code: "1040020019", name: "H.R.C. FUSE, BLADE CONTACT, 400 A", standard: 6, unit: "เธญเธฑเธ", category: "ล่อฟ้าและฟิวส์" },
    { code: "1040020100", name: "ฟิวส์สวิตช์แรงต่ำ 1x400 แอมป์ 500 โวลท์", standard: 40, unit: "เธเธธเธ”", category: "ล่อฟ้าและฟิวส์" },
    { code: "1040020102", name: "เธชเธงเธดเธ•เธเนเนเธฃเธเธ•เนเธณเนเธเธเธซเธธเนเธกเธเธเธงเธ เธเธเธดเธ” 1 เน€เธเธช", standard: 40, unit: "เธเธธเธ”", category: "เธฅเนเธญเธเนเธฒเนเธฅเธฐเธเธดเธงเธชเน" },
...
function getItemStatus(currentQty, standardQty) {
    ...
    else return { key: "over", label: "🔵 เกิน 100% (Over Stock)", pct, badgeClass: "badge-info" };
}
